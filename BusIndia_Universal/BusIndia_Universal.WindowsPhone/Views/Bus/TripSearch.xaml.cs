...
namespace BusIndia_Universal
{
    ...
    public sealed partial class TripSearch : Page
    {
        ...
        private void ListMenuItems_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (ListMenuItems.SelectedItem != null)
            {
                ...
                else if (CommantripType == "FirstTrip")
                {
                    ...
                    myobject.placeCodeFrom = txtBFromCode.Text;
                    myobject.placeCodeTo = txtBToCode.Text;
                    myobject.tripType = "FirstTrip";
                    pickDropHelper.objGetAvailableService = myobject;
                    GetAvailableServicesReturn obj = new GetAvailableServicesReturn();
                    obj.corpCode = myobject.corpCode;
                    obj.className = myobject.className;
                    obj.fare = myobject.fare;
                    obj.journeyDate = myobject.journeyDate;
                    obj.journeyHours = myobject.journeyHours;
                    obj.placeNameFrom = myobject.placeNameFrom;
                    obj.placeNameTo = myobject.placeNameTo;
                    obj.departureTime = myobject.departureTime;
                    obj.arrivalTime = myobject.arrivalTime;
                    obj.tripCode = myobject.tripCode;
                    obj.journeyHours = myobject.journeyHours;
                    obj.placeNameFrom = myobject.placeNameFrom;
                    obj.tripType = "FirstTrip";
                    obj.viaPlaces = myobject.viaPlaces;
                    pickDropHelper.objGetASReturn = obj;               
                     Frame.Navigate(typeof(BusSeatSelection), myobject);
        ...
        private void lblRetry_Click(object sender, RoutedEventArgs e)
        {
            ...
            getBusSearch obj = new getBusSearch();
            obj.placeCodeFrom = lblFromPlace.Text;
            obj.placeCodeTo=  lblToPlace.Text;
            obj. Date= lblJrnyDate.Text;
            obj.Fromplace= txtBFromLocationT.Text;
            obj.Toplace= txtBToLocationT.Text;       
            obj.placeIDFrom= txtBFromID.Text ;         
            obj.placeIDTo= txtBToID.Text ;
            Frame.Navigate(typeof(TripSearch),obj);
        }
